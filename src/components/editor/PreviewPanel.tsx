...
const STYLE_TAG_ID = "baseui-style-override";
...
export function PreviewPanel({ mode }: PreviewPanelProps) {
  ...
  // Inject generated style CSS into the document whenever style config changes.
  useEffect(() => {
    ...
    tag.textContent = generateStyleCSS(styleState, currentTokens.background);

    return () => {
      // intentionally leave the tag so rapid updates don't flicker
    };
  }, [styleState, currentTokens.background]);
  ...
  const isGlass = styleState.mode === "glass";

  return (
    <ScrollArea className="h-full">
      {/* data-ui-style is what the injected CSS scopes its overrides to */}
      <div
        data-ui-style={styleState.mode}
        style={{
          ...cssVars,
          ...
          <div
            ...
            style={{
              ...
              background: `linear-gradient(135deg,
                color-mix(in srgb, ${currentTokens["chart-1"]} 55%, transparent) 0%,
                color-mix(in srgb, ${currentTokens["chart-2"]} 45%, transparent) 40%,
                color-mix(in srgb, ${currentTokens["chart-3"]} 35%, transparent) 100%)`,
            }}
          />
        )}
            ...
            <Tabs defaultValue="overview" className="max-w-lg">
              ...
              <TabsContent value="overview">
                <p className="text-sm text-[var(--muted-foreground)] mt-2">
                  Overview — a summary of your project stats.
                </p>
              </TabsContent>
              <TabsContent value="analytics">
                <p className="text-sm text-[var(--muted-foreground)] mt-2">
                  Analytics — your data visualizations live here.
                </p>
              </TabsContent>
          ...
          <Section title="Dashboard Layout">
            ...
            >
              <div className="flex h-full min-h-[320px]">
                {/* Sidebar */}
                <div
                  className="w-48 border-r border-[var(--sidebar-border)] flex flex-col py-4 shrink-0"
          ...
          <Section title="Typography">
            <div className="space-y-3 max-w-lg">
              ...
              <p className="text-sm text-[var(--muted-foreground)]">
                Muted helper text for descriptions and secondary information.
              </p>
